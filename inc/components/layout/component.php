...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		$widgets = array(
			'sidebar-primary'   => __( 'Sidebar 1', 'jmsiteam' ),
			'sidebar-secondary' => __( 'Sidebar 2', 'jmsiteam' ),
			'footer1'           => __( 'Footer 1', 'jmsiteam' ),
			'footer2'           => __( 'Footer 2', 'jmsiteam' ),
			'footer3'           => __( 'Footer 3', 'jmsiteam' ),
			'footer4'           => __( 'Footer 4', 'jmsiteam' ),
			'footer5'           => __( 'Footer 5', 'jmsiteam' ),
			'footer6'           => __( 'Footer 6', 'jmsiteam' ),
		);
			...
			register_sidebar(
				apply_filters(
					...
					array(
						'name'          => $name,
						'id'            => $id,
						'description'   => esc_html__( 'Add widgets here.', 'jmsiteam' ),
