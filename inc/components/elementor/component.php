...
class Component implements Component_Interface {
	...
	public function add_styles() {
		wp_enqueue_style( 'base-elementor', get_theme_file_uri( '/assets/css/elementor.min.css' ), array(), jmsiteam_VERSION );
	}
	/**
	...
	public function elementor_add_scripts() {
		if ( apply_filters( 'base_add_global_colors_to_elementor', true ) ) {
			wp_enqueue_style( 'base-elementor-admin', get_theme_file_uri( '/assets/css/elementor-admin.min.css' ), array(), jmsiteam_VERSION );
		}
	}
	/**
	...
	public function elementor_add_theme_colors() {
		if ( apply_filters( 'base_add_global_colors_to_elementor', true ) ) {
			...
			$theme_colors = array(
				array(
					'_id' => 'base1',
					'title'  => __( 'Theme Accent', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette1' ),
				),
				array(
					'_id' => 'base2',
					'title'  => __( 'Theme Accent - alt', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette2' ),
				),
				array(
					'_id' => 'base3',
					'title'  => __( 'Strongest text', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette3' ),
				),
				array(
					'_id' => 'base4',
					'title'  => __( 'Strong Text', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette4' ),
				),
				array(
					'_id' => 'base5',
					'title'  => __( 'Medium text', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette5' ),
				),
				array(
					'_id' => 'base6',
					'title'  => __( 'Subtle Text', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette6' ),
				),
				array(
					'_id' => 'base7',
					'title'  => __( 'Subtle Background', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette7' ),
				),
				array(
					'_id' => 'base8',
					'title'  => __( 'Lighter Background', 'jmsiteam' ),
					'color' => webapp()->palette_option( 'palette8' ),
				),
				array(
					'_id' => 'base9',
					'title'  => __( 'White or offwhite', 'jmsiteam' ),
	...
	public function elementor_add_theme_color_controls( $tab, $args ) {
		if ( apply_filters( 'base_add_global_colors_to_elementor', true ) ) {
			$tab->start_controls_section(
				...
				array(
					'label' => __( 'Theme Global Colors', 'jmsiteam' ),
					'tab' => 'global-colors',
				)
			);
