...
class Component implements Component_Interface {
	...
	public function give_styles() {
		wp_enqueue_style( 'base-givewp', get_theme_file_uri( '/assets/css/givewp.min.css' ), array(), jmsiteam_VERSION );
	}
	/**
	 * Adds theme output Wrapper.
	 */
	...
	public function add_iframe_fonts() {
		...
		if ( ! empty( $google_fonts_url ) ) {
			if ( webapp()->option( 'load_fonts_local' ) ) {
				...
				wp_enqueue_style( 'base-givewp-iframe-fonts', $google_fonts_url, 'give-sequoia-template-css', jmsiteam_VERSION ); // phpcs:ignore WordPress.WP.EnqueuedResourceParameters.MissingVersion
			}
		}
	}
	/**
