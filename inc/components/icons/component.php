	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		...
		switch ( $icon ) {
			case 'moon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'sun':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'settings':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Settings', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'home':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Home', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'search':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'zoom':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Zoom In', 'jmsiteam' ) ) . '</title>';
				}
				$output .= '<path d="M18 13c0-3.859-3.141-7-7-7s-7 3.141-7 7 3.141 7 7 7 7-3.141 7-7zM26 26c0 1.094-0.906 2-2 2-0.531 0-1.047-0.219-1.406-0.594l-5.359-5.344c-1.828 1.266-4.016 1.937-6.234 1.937-6.078 0-11-4.922-11-11s4.922-11 11-11 11 4.922 11 11c0 2.219-0.672 4.406-1.937 6.234l5.359 5.359c0.359 0.359 0.578 0.875 0.578 1.406z"></path>
				</svg>';
				break;
			case 'bag':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bag', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'facebook':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'twitter':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'tiktok':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'TikTok', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'discord':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discord', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'instagram':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'vimeo':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Vimeo', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'youtube':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'github':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'rss':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'facebook_group':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook Group', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'dribbble':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dribbble', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'xing':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Xing', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'wordpress': // phpcs:ignore WordPress.WP.CapitalPDangit.Misspelled
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WordPress', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'whatsapp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WhatsApp', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'vk':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'VK', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'tumblr':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Tumblr', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'reddit':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'patreon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Patreon', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'medium':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Medium', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'behance':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Behance', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'anchor':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Anchor', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'soundcloud':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'email':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'phone':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'google_reviews':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Google Reviews', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'telegram':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'trip_advisor':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Trip Advisor', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'yelp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Yelp', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'user':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'User', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'comments':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'folder':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Categories', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'grid':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'list':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'List', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'account':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'pinterest':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'mobile':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Mobile', 'jmsiteam' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'hours':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'location':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'envelop':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Envelop', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'linkedin':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'goodreads':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Goodreads', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'amazon':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Amazon', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'bookbub':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'BookBub', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'quotes':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Quotes', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'arrow-left':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'arrow-right':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Next', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'arrow-right-alt':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Continue', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'arrow-down':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Expand', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'arrow-up':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'menu':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'listFilter':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'close':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'shopping-bag':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'apple_podcasts':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Podcasts', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'spotify':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Spotify', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'flickr':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Flicker', 'jmsiteam' ) ) . '</title>';
				}
			...
			case '500px':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( '500PX', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'bandcamp':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bandcamp', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'imdb':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'IMDB', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'spinner':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Loading', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'check':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Done', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'checkbox':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'disc':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Disc', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'visa':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Visa Card', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'mastercard':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'MasterCard', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'amex':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'American Express', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'discover':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discover Card', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'paypal':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 780 501" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'PayPal', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'applepay':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Pay', 'jmsiteam' ) ) . '</title>';
				}
			...
			case 'stripe':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Stripe', 'jmsiteam' ) ) . '</title>';
				}
