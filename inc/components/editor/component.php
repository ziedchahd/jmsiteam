...
class Component implements Component_Interface {
	...
	public function action_add_editor_support() {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => __( 'Small', 'jmsiteam' ),
					'shortName' => __( 'S', 'jmsiteam' ),
					'size'      => 14,
					'slug'      => 'small',
				),
				array(
					'name'      => __( 'Medium', 'jmsiteam' ),
					'shortName' => __( 'M', 'jmsiteam' ),
					'size'      => 24,
					'slug'      => 'medium',
				),
				array(
					'name'      => __( 'Large', 'jmsiteam' ),
					'shortName' => __( 'L', 'jmsiteam' ),
					'size'      => 32,
					'slug'      => 'large',
				),
				array(
					'name'      => __( 'Larger', 'jmsiteam' ),
					'shortName' => __( 'XL', 'jmsiteam' ),
					'size'      => 40,
					'slug'      => 'larger',
				),
			)
