...
class Component implements Component_Interface {
	...
	*/
	public function base_theme_updater( $transient ) {
		...
		if( false == $remote = get_transient( 'jmsiteam-theme-update'.$version ) ) {

			// connect to a remote server where the update information is stored
			$remote = wp_remote_get(
				'https://jmsiteam.org/updates/jmsiteam.json',
				array(
					'timeout' => 10,
					'headers' => array(
			...
			set_transient( 'jmsiteam-theme-update'.$version, $remote, HOUR_IN_SECONDS );
