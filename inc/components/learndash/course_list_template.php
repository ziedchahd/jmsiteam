...
$button_text = isset( $button_text ) && ! empty( $button_text ) ? $button_text : __( 'See more...', 'jmsiteam' );
...
if ( function_exists( 'learndash_get_course_price' ) ) {
	...
	$price = $course_options && isset( $course_options['sfwd-courses_course_price'] ) ? $course_options['sfwd-courses_course_price'] : __( 'Free', 'jmsiteam' );
