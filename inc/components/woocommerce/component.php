...
class Component implements Component_Interface {
	...
	public function cart_summary_title() {
		echo '<div class="cart-summary"><h2>' . esc_html__( 'Cart Summary', 'jmsiteam' ) . '</h2></div>';
	}
	/**
	...
	public function myaccount_nav_avatar() {
		...
		if ( webapp()->option( 'woo_account_navigation_avatar' ) && 0 !== $current_user->ID ) {
			...
			<div class="base-account-avatar">
				...
				<a class="bst-link-to-gravatar" href="https://gravatar.com/" target="_blank" rel="no" title="<?php echo esc_attr__( 'Update Profile Photo', 'jmsiteam' ); ?>">
	...
	public function toggle_list() {
		...
		if ( 1 === wc_get_loop_prop( 'columns' ) ) {
			echo '<div class="base-product-toggle-container base-product-toggle-outer base-single-to-grid">';
				echo '<button title="' . esc_attr__( 'List View', 'jmsiteam' ) . '" class="base-toggle-shop-layout base-toggle-list toggle-active" data-archive-toggle="list">';
					webapp()->print_icon( 'list', '', false );
				echo '</button>';
				echo '<button title="' . esc_attr__( 'Grid View', 'jmsiteam' ) . '" class="base-toggle-shop-layout base-toggle-grid" data-archive-toggle="grid">';
					webapp()->print_icon( 'grid', '', false );
				echo '</button>';
			echo '</div>';
		} else {
			echo '<div class="base-product-toggle-container base-product-toggle-outer">';
				echo '<button title="' . esc_attr__( 'Grid View', 'jmsiteam' ) . '" class="base-toggle-shop-layout base-toggle-grid toggle-active" data-archive-toggle="grid">';
					webapp()->print_icon( 'grid', '', false );
				echo '</button>';
				echo '<button title="' . esc_attr__( 'List View', 'jmsiteam' ) . '" class="base-toggle-shop-layout base-toggle-list" data-archive-toggle="list">';
					webapp()->print_icon( 'list', '', false );
				echo '</button>';
			echo '</div>';
		}
