		...
		if ( is_null( self::$default_options ) ) {
			self::$default_options = apply_filters(
				...
				array(
					...
					// Header HTML.
					'header_html_content'    => __( 'Insert HTML here', 'jmsiteam' ),
					...
					// Header Button.
					'header_button_label'      => __( 'Button', 'jmsiteam' ),
					'header_button_link'      => '',
					...
					'mobile_button_label'      => __( 'Button', 'jmsiteam' ),
					...
					// Mobile Header HTML.
					'mobile_html_content'    => __( 'Insert HTML here', 'jmsiteam' ),
					...
					'product_content_element_price' => array(
						'enabled' => true,
						'show_shipping' => false,
						'shipping_statement' => __( '& Free Shipping', 'jmsiteam' ),
					),
					...
					'product_content_element_extras' => array(
						'enabled'   => false,
						'title'     => __( 'Free shipping on orders over $50!', 'jmsiteam' ),
						'feature_1' => __( 'Satisfaction Guaranteed', 'jmsiteam' ),
						'feature_2' => __( 'No Hassle Refunds', 'jmsiteam' ),
						'feature_3' => __( 'Secure Payments', 'jmsiteam' ),
						'feature_4' => '',
						'feature_5' => '',
					...
					'product_content_element_payments' => array(
						'enabled' => false,
						'title'     => __( 'GUARANTEED SAFE CHECKOUT', 'jmsiteam' ),
						'visa' => true,
						'mastercard' => true,
						'amex' => true,
						'discover' => true,
