...
class BaseThemeLayout extends Component {
	...
	render() {
		...
		const titleOptions = {
			'default': {
				tooltip: __( 'Inherited Default', 'jmsiteam' ),
				icon: 'inherit',
			},
			'hide': {
				tooltip: __( 'Hide Title', 'jmsiteam' ),
				icon: 'hidetitle',
			},
			'normal': {
				tooltip: __( 'Show In Content', 'jmsiteam' ),
				icon: 'incontent',
			},
			'above': {
				tooltip : __( 'Show Above Content', 'jmsiteam' ),
				icon: 'abovecontent',
			},
		}
		...
		return (
			<Fragment>
				<PluginSidebarMoreMenuItem
					...
					icon={ icon }
				>
					{ baseMetaParams.post_type_name + ' ' + __( 'Settings', 'jmsiteam' ) }
				</PluginSidebarMoreMenuItem>
				<PluginSidebar
					isPinnable={ true }
					icon={ icon }
					name="theme-meta-panel"
					title={ baseMetaParams.post_type_name + ' ' + __( 'Settings', 'jmsiteam' ) }
				>
					<div className="base-sidebar-container components-panel__body is-opened">
						...
						/>
						<RadioIconComponent
							label={ baseMetaParams.post_type_name + ' ' + __( 'Title', 'jmsiteam' ) }
							customClass="three-col-short"
						...
						/>
						<RadioIconComponent
							label={ baseMetaParams.post_type_name + ' ' + __( 'Layout', 'jmsiteam' ) }
						...
						<RadioIconComponent
							label={ __( 'Content Style', 'jmsiteam' ) }
						...
						/>
						<RadioIconComponent
							label={ __( 'Content Vertical Padding', 'jmsiteam' ) }
						...
						{ baseMetaParams.supports_feature && (
							<Fragment>
								<RadioIconComponent
									label={ __( 'Show Featured Image', 'jmsiteam' ) }
								...
								{ ( ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && 'show' === this.props.meta._bst_post_feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && 'default' === this.props.meta._bst_post_feature && 'show' === baseMetaParams.feature ) || ( undefined !== this.props.meta && undefined !== this.props.meta._bst_post_feature && '' === this.props.meta._bst_post_feature && 'show' === baseMetaParams.feature ) ) && (
									<RadioIconComponent
										label={ __( 'Featured Image Position', 'jmsiteam' ) }
						...
						<ToggleControl
							label={ __( 'Disable Header', 'jmsiteam' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Disable Footer', 'jmsiteam' ) }
