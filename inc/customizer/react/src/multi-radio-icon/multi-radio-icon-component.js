...
class RadioIconComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			include: {
				logo_only: {
					tooltip: __( 'Logo Only', 'jmsiteam' ),
					name: __( 'Logo', 'jmsiteam' ),
				},
				logo_title: {
					tooltip: __( 'Logo & Title', 'jmsiteam' ),
					name: __( 'Logo & Title', 'jmsiteam' ),
				},
				logo_title_tagline: {
					tooltip: __( 'Logo, Title & Tagline', 'jmsiteam' ),
					name: __( 'Logo, Title & Tagline', 'jmsiteam' ),
				},
			},
			layout: {
				logo_only: {
				...
				logo_title: {
					...
					title_logo: {
						tooltip: __( 'Title - Logo', 'jmsiteam' ),
						icon: Icons.titleLogo
					},
					top_logo_title: {
						tooltip: __( 'Top Logo - Title', 'jmsiteam' ),
						icon: Icons.topLogoTitle
					},
					top_title_logo: {
						tooltip: __( 'Top Title - Logo', 'jmsiteam' ),
				...
				logo_title_tagline: {
					...
					title_tag_logo: {
						tooltip: __( 'Title - Tagline - Logo', 'jmsiteam' ),
						icon: Icons.titleTagLogo
					},
					top_logo_title_tag: {
						tooltip: __( 'Top Logo - Title - Tagline', 'jmsiteam' ),
						icon: Icons.topLogoTitleTag
					},
					top_title_tag_logo: {
						tooltip: __( 'Top Title - Tagline - Logo', 'jmsiteam' ),
						icon: Icons.topTitleTagLogo
					},
					top_title_logo_tag: {
						tooltip: __( 'Top Title - Logo - Tagline', 'jmsiteam' ),
