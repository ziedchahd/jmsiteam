...
class ColorComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			colors: {
				palette1: {
					tooltip: __( '1 - Accent', 'jmsiteam' ),
					palette: false,
				},
				palette2: {
					tooltip: __( '2 - Accent - alt', 'jmsiteam' ),
					palette: false,
				},
				palette3: {
					tooltip: __( '3 - Strongest text', 'jmsiteam' ),
					palette: false,
				},
				palette4: {
					tooltip: __( '4 - Strong Text', 'jmsiteam' ),
					palette: false,
				},
				palette5: {
					tooltip: __( '5 - Medium text', 'jmsiteam' ),
					palette: false,
				},
				palette6: {
					tooltip: __( '6 - Subtle Text', 'jmsiteam' ),
					palette: false,
				},
				palette7: {
					tooltip: __( '7 - Subtle Background', 'jmsiteam' ),
					palette: false,
				},
				palette8: {
					tooltip: __( '8 - Lighter Background', 'jmsiteam' ),
					palette: false,
				},
				palette9: {
					tooltip: __( '9 - White or offwhite', 'jmsiteam' ),
					palette: false,
				},
			},
			paletteMap: {
				'palette': {
					'tooltip': __( 'Palette 1', 'jmsiteam' ),
				},
				'second-palette': {
					'tooltip': __( 'Palette 2', 'jmsiteam' ),
				},
				'third-palette': {
					'tooltip': __( 'Palette 3', 'jmsiteam' ),
				}
			}
		};
		...
		return (
				<div className="base-control-field base-palette-control base-color-control">
							...
							<Popover position="bottom right" className="base-palette-popover-copy-paste" onClose={ toggleClose }>
								<TabPanel className="base-palette-popover-tabs"
									...
									tabs={ [
										{
											name: 'import',
											title: __( 'Select a Color Set', 'jmsiteam' ),
											className: 'base-color-presets',
										},
										{
											name: 'custom',
											title: __( 'Export/Import', 'jmsiteam' ),
													...
													tabout = (
														<Fragment>
															...
															{ this.state.importError && (
																<p style={{color:'red'}}>{ __( 'Error with Import data', 'jmsiteam') }</p>
															) }
															<Button
					...
					{ this.props.control.params.description && (
						<span className="customize-control-description"><a href="https://jmsiteam.org/color-palette" target="_blank">{ this.props.control.params.description }</a></span>
					) }
				</div>
		);
	}
