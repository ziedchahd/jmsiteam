...
class ContactComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'phone', label: __( 'Phone', 'jmsiteam' ), content: __( '444-546-8765', 'jmsiteam' ) },
				{ value: 'hours', label: __( 'Hours', 'jmsiteam' ), content: __( 'Mon - Fri: 8AM - 5PM', 'jmsiteam' ) },
				{ value: 'email', label: __( 'Email', 'jmsiteam' ), content: __( 'example@example.com', 'jmsiteam' ) },
				{ value: 'location', label: __( 'Address', 'jmsiteam' ), content: __( '4560 example street', 'jmsiteam' ) },
			],
		};
