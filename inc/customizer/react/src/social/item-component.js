			...
			<div className="base-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="base-sorter-item-panel-header">
					...
					<span className="base-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Social Item', 'jmsiteam' ) ) }
					</span>
										...
										if ( 'image' === tab.name ) {
											tabout = (
												<Fragment>
													...
													<RangeControl
														label={ __( 'Max Width (px)', 'jmsiteam' ) }
