...
class BackgroundComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			...
			repeat: {
				'no-repeat': {
					name: __( 'No Repeat', 'jmsiteam' ),
				},
				'repeat': {
					name: __( 'Repeat', 'jmsiteam' ),
				},
				'repeat-x': {
					name: __( 'Repeat-X', 'jmsiteam' ),
				},
				'repeat-y': {
					name: __( 'Repeat-y', 'jmsiteam' ),
				},
			},
			size: {
				auto: {
					name: __( 'Auto', 'jmsiteam' ),
				},
				cover: {
					name: __( 'Cover', 'jmsiteam' ),
				},
				contain: {
					name: __( 'Contain', 'jmsiteam' ),
				},
			},
			attachment: {
				scroll: {
					name: __( 'Scroll', 'jmsiteam' ),
				},
				fixed: {
					name: __( 'Fixed', 'jmsiteam' ),
				},
			},
			attachments: {
				desktop: {},
	...
	render() {
		...
		if( this.state.supportGradient ) {
			tab_options = [
				{
					name: 'color',
					title: __( 'Color', 'jmsiteam' ),
					className: 'base-color-background',
				},
				{
					name: 'gradient',
					title: __( 'Gradient', 'jmsiteam' ),
					className: 'base-gradient-background',
				},
				{
					name: 'image',
					title: __( 'Image', 'jmsiteam' ),
			...
			<div className="base-control-field base-background-control">
				...
				>
					<div className="base-background-picker-wrap">
												...
												if ( 'image' === tab.name ) {
													tabout = (
														<Fragment>
															...
															<span className="customize-control-title">{ __( 'Background Repeat', 'jmsiteam' ) }</span>
															...
															<span className="customize-control-title">{ __( 'Background Size', 'jmsiteam' ) }</span>
															<ButtonGroup className="base-radio-container-control">
															...
															<span className="customize-control-title">{ __( 'Background Attachment', 'jmsiteam' ) }</span>
															<ButtonGroup className="base-radio-container-control">
						...
						<Tooltip text={ this.controlParams.tooltip ? this.controlParams.tooltip : __( 'Select Background', 'jmsiteam' ) }>
