		...
		return (
			<div className={ `base-builder-areas ${ centerClass }` }>
				<Button
					...
					aria-label={ __( 'Edit Settings for', 'jmsiteam' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'jmsiteam' ) : this.props.row + ' ' + __( 'Row', 'jmsiteam' ) ) }
				...
				<Button
					...
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
				>
					{ ( this.props.row === 'popup' ? __( 'Off Canvas', 'jmsiteam' ) : this.props.row + ' ' + __( 'Row', 'jmsiteam' ) ) }
