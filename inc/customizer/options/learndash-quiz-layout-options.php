...
$settings = array(
	...
	'sfwd-quiz_title_font' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Title Font', 'jmsiteam' ),
	...
	'sfwd-quiz_title_background' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Above Area Background', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Quiz Title Background', 'jmsiteam' ),
		),
	),
	...
	'sfwd-quiz_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Background', 'jmsiteam' ),
		),
	),
	'sfwd-quiz_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Content Background', 'jmsiteam' ),
		),
	),
);
