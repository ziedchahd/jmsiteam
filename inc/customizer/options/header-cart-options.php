...
Theme_Customizer::add_settings(
	array(
		...
		'header_cart_label' => array(
			...
			'label'        => esc_html__( 'Cart Label', 'jmsiteam' ),
			'live_method'     => array(
				array(
					'type'     => 'html',
		...
		'header_cart_icon' => array(
			...
			'label'        => esc_html__( 'Cart Icon', 'jmsiteam' ),
			'partial'      => array(
		...
		'header_cart_style' => array(
			...
			'label'        => esc_html__( 'Cart Click Action', 'jmsiteam' ),
			'transport'    => 'refresh',
			'input_attrs'  => array(
				'layout' => array(
					'link' => array(
						'name' => __( 'Link', 'jmsiteam' ),
					),
					'slide' => array(
						'name' => __( 'Popout Cart', 'jmsiteam' ),
					),
					'dropdown' => array(
						'name' => __( 'Dropdown Cart', 'jmsiteam' ),
					),
				),
				'responsive' => false,
			),
		...
		'header_cart_show_total' => array(
			...
			'label'        => esc_html__( 'Show Item Total Indicator', 'jmsiteam' ),
		),
		...
		'header_cart_background' => array(
			'control_type' => 'base_color_control',
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Background', 'jmsiteam' ),
		...
		'header_cart_total_background' => array(
			'control_type' => 'base_color_control',
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Total Background', 'jmsiteam' ),
		...
		'header_cart_typography' => array(
			...
			'section'      => 'cart_design',
			'label'        => esc_html__( 'Cart Label Font', 'jmsiteam' ),
			'context'      => array(
				array(
		...
		'header_cart_padding' => array(
			...
			'label'        => esc_html__( 'Cart Padding', 'jmsiteam' ),
			'live_method'     => array(
				array(
					'type'     => 'css',
					'selector' => '.site-header-item .header-cart-wrap .header-cart-inner-wrap .header-cart-button',
