...
$settings = array(
	...
	'footer_middle_columns' => array(
		'control_type' => 'base_radio_icon_control',
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Columns', 'jmsiteam' ),
		'priority'     => 5,
		//'transport'    => 'refresh',
	...
	'footer_middle_collapse' => array(
		...
		'label'        => esc_html__( 'Row Collapse', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
		...
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
					'name'    => __( 'Left to Right', 'jmsiteam' ),
					'icon'    => '',
				),
				'rtl' => array(
					'name'    => __( 'Right to Left', 'jmsiteam' ),
					'icon'    => '',
				),
			),
			'responsive' => false,
	...
	'footer_middle_direction' => array(
		...
		'label'        => esc_html__( 'Column Direction', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
		...
		'input_attrs'  => array(
			'layout' => array(
				'row' => array(
					'tooltip' => __( 'Left to Right', 'jmsiteam' ),
					'name'    => __( 'Row', 'jmsiteam' ),
					'icon'    => '',
				),
				'column' => array(
					'tooltip' => __( 'Top to Bottom', 'jmsiteam' ),
					'name'    => __( 'Column', 'jmsiteam' ),
					'icon'    => '',
				),
			),
			'responsive' => true,
	...
	'footer_middle_column_spacing' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'label'        => esc_html__( 'Column Spacing', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_widget_spacing' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'label'        => esc_html__( 'Widget Spacing', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_top_spacing' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'label'        => esc_html__( 'Top Spacing', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_bottom_spacing' => array(
		...
		'section'      => 'footer_middle',
		'priority'     => 5,
		'label'        => esc_html__( 'Bottom Spacing', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'footer_middle_widget_title' => array(
		...
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Widget Titles', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'footer_middle_widget_content' => array(
		'control_type' => 'base_typography_control',
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Widget Content', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'footer_middle_link_colors' => array(
		...
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Link Colors', 'jmsiteam' ),
	...
	'footer_middle_link_style' => array(
		...
		'label'        => esc_html__( 'Link Style', 'jmsiteam' ),
		'input_attrs'  => array(
			'options' => array(
				'plain' => array(
					'name' => __( 'Underline on Hover', 'jmsiteam' ),
				),
				'normal' => array(
					'name' => __( 'Underline', 'jmsiteam' ),
				),
				'noline' => array(
					'name' => __( 'No Underline', 'jmsiteam' ),
				),
			),
		),
		'live_method'     => array(
	...
	'footer_middle_background' => array(
		...
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Middle Row Background', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Middle Row Background', 'jmsiteam' ),
		),
	),
	'footer_middle_column_border' => array(
		'control_type' => 'base_border_control',
		'section'      => 'footer_middle',
		'label'        => esc_html__( 'Column Border', 'jmsiteam' ),
