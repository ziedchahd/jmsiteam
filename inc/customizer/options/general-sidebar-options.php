...
Theme_Customizer::add_settings(
	array(
		...
		'sidebar_width' => array(
			...
			'section'      => 'sidebar',
			'priority'     => 10,
			'label'        => esc_html__( 'Sidebar Width', 'jmsiteam' ),
			// 'context'      => array(
			// 	array(
		...
		'sidebar_background' => array(
			...
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Background', 'jmsiteam' ),
			...
			'input_attrs'  => array(
				'tooltip'  => __( 'Sidebar Background', 'jmsiteam' ),
			),
		),
		'sidebar_divider_border' => array(
			'control_type' => 'base_border_control',
			'section'      => 'sidebar_design',
			'label'        => esc_html__( 'Sidebar Divider Border', 'jmsiteam' ),
		...
		'sidebar_padding' => array(
			...
			'label'        => esc_html__( 'Sidebar Padding', 'jmsiteam' ),
			// 'context'      => array(
			// 	array(
			// 		'setting' => '__current_tab',
			// 		'value'   => 'design',
		...
		'sidebar_sticky' => array(
			...
			'label'        => esc_html__( 'Enable Sticky Sidebar', 'jmsiteam' ),
			'transport'    => 'refresh',
		),
		'sidebar_sticky_last_widget' => array(
			...
			'label'        => esc_html__( 'Only Stick Last Widget', 'jmsiteam' ),
			'transport'    => 'refresh',
			'context'      => array(
				array(
