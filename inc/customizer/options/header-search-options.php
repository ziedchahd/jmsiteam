...
$settings = array(
	...
	'header_search_label' => array(
		...
		'label'        => esc_html__( 'Search Label', 'jmsiteam' ),
		'context'      => array(
			array(
	...
	'header_search_label_visiblity' => array(
		...
		'label'        => esc_html__( 'Search Label Visibility', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_icon' => array(
		...
		'label'        => esc_html__( 'Search Icon', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'general',
	...
	'header_search_style' => array(
		...
		'label'        => esc_html__( 'Search Style', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_search_border' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Border', 'jmsiteam' ),
	...
	'header_search_color' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Colors', 'jmsiteam' ),
	...
	'header_search_background' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_search',
		'label'        => esc_html__( 'Search Background', 'jmsiteam' ),
	...
	'header_search_typography' => array(
		...
		'section'      => 'header_search',
		'label'        => esc_html__( 'Label Font', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'header_search_padding' => array(
		...
		'label'        => esc_html__( 'Search Padding', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting' => '__current_tab',
				'value'   => 'design',
	...
	'info_search_modal' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Options', 'jmsiteam' ),
		'settings'     => false,
		'context'      => array(
			array(
				'setting' => '__current_tab',
	...
	'header_search_modal_color' => array(
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'hover' => array(
					'tooltip' => __( 'Focus/Hover Color', 'jmsiteam' ),
					'palette' => true,
				),
			),
		),
	...
	'header_search_modal_background' => array(
		...
		'section'      => 'header_search',
		'priority'     => 20,
		'label'        => esc_html__( 'Modal Background', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Modal Background', 'jmsiteam' ),
		),
	),
);
	...
	$settings = array_merge(
		...
		array(
			'header_search_woo' => array(
				...
				'label'        => esc_html__( 'Search only Products?', 'jmsiteam' ),
				'transport'    => 'refresh',
				'context'      => array(
					array(
						'setting' => '__current_tab',
