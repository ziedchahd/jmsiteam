...
$settings = array(
	...
	'header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky Header?', 'jmsiteam' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'jmsiteam' ),
				...
				'main' => array(
					'name' => __( 'Yes - Only Main Row', 'jmsiteam' ),
				),
				'top_main' => array(
					'name' => __( 'Yes - Top Row & Main Row', 'jmsiteam' ),
				),
				'top_main_bottom' => array(
					'name' => __( 'Yes - Whole Header', 'jmsiteam' ),
				),
				'top' => array(
					'name' => __( 'Yes - Only Top Row', 'jmsiteam' ),
				),
				'bottom' => array(
					'name' => __( 'Yes - Only Bottom Row', 'jmsiteam' ),
				),
			),
		),
	),
	'header_reveal_scroll_up' => array(
		...
		'label'        => esc_html__( 'Enable Reveal Sticky on Scroll up', 'jmsiteam' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
	...
	'header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enable Main Row Shrinking', 'jmsiteam' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'header_sticky',
	...
	'header_sticky_main_shrink' => array(
		...
		'section'      => 'header_sticky',
		'label'        => esc_html__( 'Main Row Shrink Height', 'jmsiteam' ),
		'context'      => array(
			array(
	...
	'header_sticky_custom_logo' => array(
		...
		'label'        => esc_html__( 'Different Logo for Stuck Header?', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
	...
	'header_sticky_logo' => array(
		...
		'mime_type'    => 'image',
		'default'      => '',
		'label'        => esc_html__( 'Stuck Header Logo', 'jmsiteam' ),
		'context'      => array(
			array(
				'setting'    => 'logo_layout',
				'operator'   => 'sub_object_contains',
	...
	'info_mobile_header_sticky' => array(
		...
		'section'      => 'header_sticky',
		'priority'     => 20,
		'label'        => esc_html__( 'Mobile Sticky', 'jmsiteam' ),
		'settings'     => false,
	),
	'mobile_header_sticky' => array(
		...
		'label'        => esc_html__( 'Enable Sticky for Mobile?', 'jmsiteam' ),
		'input_attrs'  => array(
			'options' => array(
				'no' => array(
					'name' => __( 'No', 'jmsiteam' ),
	...
	'mobile_header_sticky_shrink' => array(
		...
		'label'        => esc_html__( 'Enabled Main Row Shrinking', 'jmsiteam' ),
		'transport'    => 'refresh',
		'context'      => array(
			array(
				'setting'  => 'mobile_header_sticky',
	...
	'header_sticky_site_title_color' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Site Title Color', 'jmsiteam' ),
	...
	'header_sticky_navigation_background' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Navigation Items Background', 'jmsiteam' ),
	...
	'header_sticky_button_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Button Colors', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'background' => array(
					'tooltip' => __( 'Background', 'jmsiteam' ),
					'palette' => true,
				),
				'backgroundHover' => array(
					'tooltip' => __( 'Background Hover', 'jmsiteam' ),
					'palette' => true,
				),
				'border' => array(
					'tooltip' => __( 'Border', 'jmsiteam' ),
					'palette' => true,
				),
				'borderHover' => array(
					'tooltip' => __( 'Border Hover', 'jmsiteam' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_social_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Social Colors', 'jmsiteam' ),
	...
	'header_sticky_html_color' => array(
		'control_type' => 'base_color_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'HTML Colors', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'colors' => array(
				...
				'link' => array(
					'tooltip' => __( 'Link Color', 'jmsiteam' ),
					'palette' => true,
				),
				'hover' => array(
					'tooltip' => __( 'Link Hover', 'jmsiteam' ),
					'palette' => true,
				),
			),
		),
	...
	'header_sticky_background' => array(
		...
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Header Background', 'jmsiteam' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Sticky Header Background', 'jmsiteam' ),
		),
	),
	'header_sticky_bottom_border' => array(
		'control_type' => 'base_border_control',
		'section'      => 'header_sticky_design',
		'label'        => esc_html__( 'Sticky Bottom Border', 'jmsiteam' ),
	...
	$settings = array_merge(
		...
		array(
			'header_sticky_cart_color' => array(
				'control_type' => 'base_color_control',
				'section'      => 'header_sticky_design',
				'label'        => esc_html__( 'Cart Colors', 'jmsiteam' ),
			...
			'header_sticky_cart_total_color' => array(
				'control_type' => 'base_color_control',
				'section'      => 'header_sticky_design',
				'label'        => esc_html__( 'Cart Total Colors', 'jmsiteam' ),
