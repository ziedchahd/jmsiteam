...
$settings = array(
	...
	'mobile_trigger_label' => array(
		...
		'label'        => esc_html__( 'Menu Label', 'jmsiteam' ),
		'live_method'     => array(
			array(
				'type'     => 'html',
	...
	'mobile_trigger_icon' => array(
		...
		'label'        => esc_html__( 'Trigger Icon', 'jmsiteam' ),
		'partial'      => array(
	...
	'mobile_trigger_style' => array(
		...
		'label'        => esc_html__( 'Trigger Style', 'jmsiteam' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
	...
	'mobile_trigger_border' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Border', 'jmsiteam' ),
	...
	'mobile_trigger_color' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Colors', 'jmsiteam' ),
	...
	'mobile_trigger_typography' => array(
		...
		'section'      => 'mobile_trigger_design',
		'label'        => esc_html__( 'Trigger Font', 'jmsiteam' ),
		'context'      => array(
			array(
	...
	'mobile_trigger_padding' => array(
		...
		'label'        => esc_html__( 'Trigger Padding', 'jmsiteam' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
				'selector' => '.mobile-toggle-open-container .menu-toggle-open',
	...
	'info_link_drawer_container' => array(
		...
		'section'      => 'mobile_trigger',
		'priority'     => 20,
		'label'        => esc_html__( 'Drawer Container Options', 'jmsiteam' ),
		'settings'     => false,
	),
