...
function footer_html() {
	...
	if ( $content || is_customize_preview() ) {
		...
		// translators: %s is link to jmsiteam".
		$content = str_replace( '{theme-credit}', sprintf( __( '- WordPress Theme by %s', 'jmsiteam' ), '<a href="https://jmsiteam.org" rel="nofollow noopener" target="_blank">jmsiteam</a>' ), $content );
...
function footer_navigation() {
	?>
	<nav id="footer-navigation" class="footer-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Footer Navigation', 'jmsiteam' ); ?>">
